      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center space-y-8 px-4">
        ...
        >
          ...
          >
            ...
            <span className="block text-primary mt-3 bg-gradient-to-r from-purple-800 to-purple-600 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent leading-tight tracking-normal">
              Challenge the AI
            </span>
          </motion.h1>
